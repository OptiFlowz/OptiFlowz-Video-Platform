...
export default [
    ...
    route("channel-analytics", "routes/channelAnalytics.tsx"),
    route("platform-analytics", "routes/platformAnalytics.tsx"),
    route("platform-settings", "routes/platformSettings.tsx"),
    route("platform-users", "routes/platformUsers.tsx"),
