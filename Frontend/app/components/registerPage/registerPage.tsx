        ...
        <main className="login max-w-full!">
            <div>
                ...
                <Link to="/" className="mb-10 logoDiv flex gap-5 items-center cursor-pointer hover:opacity-80 transition-opacity">
                    ...
                    />
                    <span className="p-0">
                        <h3 className="font-semibold text-[1.3rem] max-[500px]:text-[1.2rem] -mb-1.25 text-(--text1)">{BRAND_NAME}</h3>
                        ...
                        {step === 2 && (
                            <>
                                        ...
                                        <button
                                            ...
                                            className={`catItem button flex items-center gap-2 p-3 rounded-[15px] transition-all ${
                                                selectedCategories.includes(category.id)
                                                    ...
                                                    : "bg-(--background3) border-2 border-(--border1) hover:border-(--accentGray)"
                                            }`}
                                ...
                                <div className="flex gap-3 mt-12 max-[800px]:mt-16">
                                    <button className="button flex-1 bg-(--background3) rounded-[30px] py-[10px] font-[200]" onClick={() => setStep(1)}>
                                        Previous
                                    </button>
                                    <button 
                        ...
                        {step === 2 && (
                            <>
                                ...
                                <textarea
                                    ref={bio}
                                    id="registrationBio"
                                    className="mt-2 w-full bg-(--background3) rounded-[15px] p-4 text-[.95rem] min-h-37.5 resize-none focus:outline-none focus:ring-2 focus:ring-(--accentBlue)"
