...
<svg width="660" height="280" viewBox="60 90 660 280" fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs>
  ...
  <style>
    ...
    @media (prefers-reduced-motion: reduce) {
      .maintenance-visual svg * { animation: none !important; }
      .maintenance-visual .hammer-carrier { transform: translate(232px, 248px); }
    }
  </style>
  <ellipse cx="380" cy="350" rx="235" ry="18" fill="var(--accentBlue2)" opacity="0.12"/>
  <g class="monitor-group">
    <rect x="300" y="126" width="160" height="110" rx="18" fill="var(--background4)" stroke="var(--accentBlue2)" stroke-width="4"/>
    <rect class="screen-glow" x="314" y="140" width="132" height="80" rx="10" fill="var(--background1)"/>
    <circle cx="350" cy="180" r="10" fill="none" stroke="var(--text1)" stroke-width="4"/>
    <path d="M350 170 L350 180 L358 186" stroke="var(--text1)" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
    <rect x="372" y="172" width="40" height="8" rx="4" fill="var(--accentBlue2)" opacity="0.65"/>
    <rect x="372" y="186" width="28" height="8" rx="4" fill="var(--text1)"/>
    <circle cx="419" cy="190" r="4" fill="var(--text1)"/>
    <rect x="370" y="236" width="20" height="16" rx="5" fill="var(--accentBlue2)"/>
    <rect x="340" y="250" width="80" height="8" rx="4" fill="var(--accentBlue2)" opacity="0.4"/>
  </g>
  <g class="tower-group">
    <rect x="500" y="162" width="64" height="112" rx="14" fill="var(--background4)" stroke="var(--accentBlue2)" stroke-width="4"/>
    <rect x="516" y="180" width="32" height="6" rx="3" fill="var(--accentBlue2)" opacity="0.65"/>
    <circle cx="532" cy="212" r="6" fill="var(--text1)"/>
    <circle cx="532" cy="236" r="4" fill="var(--accentBlue2)" opacity="0.65"/>
    <circle cx="532" cy="253" r="4" fill="var(--accentBlue2)" opacity="0.65"/>
  </g>
  <path d="M460 220 C478 220, 486 220, 500 220" stroke="var(--accentBlue2)" stroke-width="4" stroke-linecap="round" opacity="0.65"/>
  <g transform="translate(302 216)">
    <path class="spark monitor-spark-a" d="M0 -8 L3 -3 L8 0 L3 3 L0 8 L-3 3 L-8 0 L-3 -3 Z" fill="var(--text1)"/>
    <path class="spark monitor-spark-b" d="M0 -6 L2.5 -2.5 L6 0 L2.5 2.5 L0 6 L-2.5 2.5 L-6 0 L-2.5 -2.5 Z" fill="var(--accentBlue2)"/>
    <path class="spark monitor-spark-c" d="M0 -5 L2 -2 L5 0 L2 2 L0 5 L-2 2 L-5 0 L-2 -2 Z" fill="var(--text1)"/>
  </g>
  <g transform="translate(508 220)">
    <path class="spark tower-spark-a" d="M0 -8 L3 -3 L8 0 L3 3 L0 8 L-3 3 L-8 0 L-3 -3 Z" fill="var(--text1)"/>
    <path class="spark tower-spark-b" d="M0 -6 L2.5 -2.5 L6 0 L2.5 2.5 L0 6 L-2.5 2.5 L-6 0 L-2.5 -2.5 Z" fill="var(--accentBlue2)"/>
    <path class="spark tower-spark-c" d="M0 -5 L2 -2 L5 0 L2 2 L0 5 L-2 2 L-5 0 L-2 -2 Z" fill="var(--text1)"/>
  </g>
  <g class="droid-track">
    <g class="droid-bob">
      <ellipse cx="165" cy="318" rx="48" ry="10" fill="var(--accentBlue2)" opacity="0.4"/>
      <circle cx="165" cy="258" r="44" fill="var(--background4)" stroke="var(--accentBlue2)" stroke-width="4"/>
      <g class="body-roll" clip-path="url(#bb8BodyClip)">
        <circle cx="165" cy="258" r="44" fill="var(--background4)"/>
        <circle cx="165" cy="258" r="18" fill="none" stroke="var(--text1)" stroke-width="6"/>
        <circle cx="165" cy="258" r="7" fill="var(--accentBlue2)"/>
        <circle cx="138" cy="243" r="10" fill="none" stroke="var(--text1)" stroke-width="5"/>
        <circle cx="138" cy="243" r="3.5" fill="var(--accentBlue2)"/>
        <circle cx="192" cy="276" r="10" fill="none" stroke="var(--text1)" stroke-width="5"/>
        <circle cx="192" cy="276" r="3.5" fill="var(--accentBlue2)"/>
        <path d="M132 274 C144 280, 152 284, 164 286" stroke="var(--text1)" stroke-width="5" stroke-linecap="round"/>
        <path d="M179 232 C188 234, 195 238, 200 244" stroke="var(--text1)" stroke-width="5" stroke-linecap="round"/>
      </g>
      <circle cx="165" cy="258" r="44" fill="none" stroke="var(--accentBlue2)" stroke-width="4"/>
      <g class="head-look">
        <path d="M130 205 C130 185, 146 172, 165 172 C184 172, 200 185, 200 205 L200 214 L130 214 Z" fill="var(--background4)" stroke="var(--accentBlue2)" stroke-width="4" stroke-linejoin="round"/>
        <g class="antenna-wobble">
          <rect x="144" y="159" width="2.5" height="18" rx="1.25" fill="var(--accentBlue2)"/>
          <circle cx="145.25" cy="156.5" r="3.5" fill="var(--text1)"/>
          <circle cx="145.25" cy="177" r="2.2" fill="var(--accentBlue2)"/>
        </g>
        <path d="M138 191 H192" stroke="var(--text1)" stroke-width="5" stroke-linecap="round"/>
        <path d="M144 200 H186" stroke="var(--accentBlue2)" stroke-width="3.5" stroke-linecap="round" opacity="0.65"/>
        <circle cx="166" cy="196" r="11" fill="var(--background1)"/>
        <circle cx="166" cy="196" r="4" fill="var(--text1)"/>
        <g class="blink">
          <circle cx="186" cy="204" r="4.5" fill="var(--background1)"/>
        </g>
      </g>
      <g class="hammer-carrier">
        <g class="hammer-tilt">
          <circle cx="0" cy="0" r="7" fill="var(--accentBlue2)"/>
          <rect x="-4" y="-28" width="8" height="46" rx="4" fill="var(--text1)"/>
          <rect x="-18" y="-38" width="36" height="12" rx="6" fill="var(--accentBlue2)"/>
        </g>
      </g>
    </g>
  </g>
