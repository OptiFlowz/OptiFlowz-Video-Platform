        ...
        <section>
          ...
          <span className="checkInputField flex items-center gap-2">
            <input
              ...
              checked:after:content-['✓'] checked:after:absolute checked:after:text-(--colorWhite) checked:after:text-sm checked:after:left-1/2 checked:after:top-1/2 checked:after:-translate-x-1/2 checked:after:-translate-y-1/2"
              type="checkbox"
              id="rememberMe"
