          ...
          <div className="quizPopupScroll flex min-h-0 flex-1 flex-col overflow-y-auto">
            <div className="flex items-center gap-4">
              <h4 className="flex items-center gap-2 text-base font-semibold">
                {t("quizRulesButton")}
                {rulesResponse ? <span className="rounded-full bg-(--background2) px-2.5 py-0.5 text-sm tabular-nums opacity-75">{rules.length}</span> : null}
              </h4>
            </div>
                    ...
                    <div className="mt-3 flex items-center justify-between gap-2 sm:gap-4">
                      ...
                      <div className="flex shrink-0 items-center gap-2 whitespace-nowrap">
                        ...
                        <button
                          type="button"
                          disabled={togglingRuleId === rule.id}
                          className="cursor-pointer rounded-full border border-(--accentRed) bg-(--background15) px-3 py-1.5 text-sm text-(--accentRed3) transition-colors disabled:cursor-wait disabled:opacity-50"
