  ...
  template.innerHTML = String.raw/*html*/`
    ...
    <style>
      :host {
        ...
        --_accent-color: var(--media-accent-color, var(--text1));
      ...
      media-controller {
        ...
        --media-control-hover-background: color-mix(in srgb, var(--borderWhite) 10%, transparent);
        --media-tooltip-background: color-mix(in srgb, var(--background1) 50%, transparent);
    ...
    --media-font-family: 'Gabarito', Roboto, helvetica neue, segoe ui, arial, sans-serif;
        ...
        --media-menu-background: color-mix(in srgb, var(--background4) 60%, transparent);
      ...
      .center media-seek-forward-button{
        ...
        background-color: color-mix(in srgb, var(--background1) 50%, transparent);
        border-radius: 9999px;
        border: 1px solid color-mix(in srgb, var(--borderWhite) 12%, transparent);
      ...
      <div class="center" slot="centered-chrome">
        ...
        <media-play-button mediapaused>
          <svg slot="icon" viewBox="0 0 24 24">
            ...
            <g id="icon-pause">
              <path id="pause-left" d="M7 16V8C7 7.44772 7.44772 7 8 7H9C9.55228 7 10 7.44772 10 8V16C10 16.5523 9.55228 17 9 17H8C7.44772 17 7 16.5523 7 16Z" stroke="var(--borderWhite)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path id="pause-right" d="M14 16V8C14 7.44772 14.4477 7 15 7H16C16.5523 7 17 7.44772 17 8V16C17 16.5523 16.5523 17 16 17H15C14.4477 17 14 16.5523 14 16Z" stroke="var(--borderWhite)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </g>
          </svg>
        </media-play-button>
      ...
      <media-text-display class="topTitle" slot="top-chrome">
        ...
        <span>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 8V8.5M12 12V16M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z" stroke="var(--borderWhite)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
          <div class="popup">
    ...
    font-family: 'Gabarito';
        ...
        .media-gradient-top::before {
          content: '';
          --gradient-steps: transparent 0%, color-mix(in srgb, var(--background1) 1.3%, transparent) 8.1%, color-mix(in srgb, var(--background1) 4.9%, transparent) 15.5%,
            color-mix(in srgb, var(--background1) 10.4%, transparent) 22.5%, color-mix(in srgb, var(--background1) 17.5%, transparent) 29%, color-mix(in srgb, var(--background1) 25.9%, transparent) 35.3%, color-mix(in srgb, var(--background1) 35.2%, transparent) 41.2%,
            color-mix(in srgb, var(--background1) 45%, transparent) 47.1%, color-mix(in srgb, var(--background1) 55%, transparent) 52.9%, color-mix(in srgb, var(--background1) 64.8%, transparent) 58.8%, color-mix(in srgb, var(--background1) 74.1%, transparent) 64.7%,
            color-mix(in srgb, var(--background1) 82.5%, transparent) 71%, color-mix(in srgb, var(--background1) 89.6%, transparent) 77.5%, color-mix(in srgb, var(--background1) 95.1%, transparent) 84.5%, color-mix(in srgb, var(--background1) 98.7%, transparent) 91.9%,
            var(--background1) 100%;
      ...
      <!-- Time Range / Progress Bar -->
        <style>
          media-time-range {
            ...
            --media-range-track-background: var(--seethroughtBlack);
            --media-range-track-border-radius: calc(0.25 * var(--base));

            --media-time-range-buffered-color: color-mix(in srgb, var(--borderWhite) 50%, transparent);
            ...
            --preview-card-background: color-mix(in srgb, var(--background1) 50%, transparent);
            --preview-card-border: color-mix(in srgb, var(--borderWhite) 12%, transparent);
          ...
          .preview-card media-preview-thumbnail {
            ...
            overflow: hidden;
            background: color-mix(in srgb, var(--background1) 35%, transparent);
      ...
      <style>
        media-settings-menu {
          ...
          background-color: color-mix(in srgb, var(--background1) 94%, transparent);
          will-change: transform, opacity, height;
          border: 1px solid color-mix(in srgb, var(--borderWhite) 12%, transparent);
          margin-right: 18px;
          margin-bottom: 8px;
        ...
        [slot='submenu']::part(back button):hover{
          background: color-mix(in srgb, var(--borderWhite) 10%, transparent);
        }
        ...
        media-settings-menu-item:hover {
          ...
          background: color-mix(in srgb, var(--borderWhite) 10%, transparent);
          border-color: color-mix(in srgb, var(--borderWhite) 18%, transparent);
        }
        ...
        /* Hide audio settings when there is only a single available track. */
        .audio-settings[submenusize='1'] {
          display: none;
        }
      </style>
      <media-settings-menu hidden anchor="auto">
        ...
        <media-settings-menu-item class="audio-settings">
          Audio Track
          <media-audio-track-menu slot="submenu" hidden>
            <div slot="title">Audio Track</div>
        ...
        <div style="display: flex; width: 100%; align-items: center; gap: calc(0.2 * var(--base))">
          <div class="player-button-group play">
            ...
            <style>
              ...
              .media-button:hover {
                /* background-color: color-mix(in srgb, var(--borderWhite) 10%, transparent); */
                /*box-shadow: color-mix(in srgb, var(--background1) 30%, transparent) 0px 0px 5px; */
                /* hue-rotate(120deg) */
                background-color: color-mix(in srgb, var(--borderWhite) 10%, transparent);
                border-color: color-mix(in srgb, var(--borderWhite) 18%, transparent);
              }
          ...
          <div class="player-button-group">
            ...
            <style>
              ...
              [keyboardcontrol] media-volume-range:focus {
                ...
                outline: 1px solid color-mix(in srgb, var(--accentBlue2) 90%, transparent);
              }
            ...
            <media-mute-button class="media-button custom-btn">
              ...
              <svg slot="icon" viewBox="0 0 24 24">
                <path d="M11.0438 5.91L7.04376 9.1125C6.81499 9.29837 6.54503 9.39765 6.26876 9.3975H5.18751C4.81844 9.39551 4.46392 9.57004 4.20236 9.88251C3.9408 10.195 3.79376 10.6196 3.79376 11.0625V12.9375C3.79376 13.3804 3.9408 13.805 4.20236 14.1175C4.46392 14.43 4.81844 14.6045 5.18751 14.6025H6.26876C6.54503 14.6024 6.81499 14.7016 7.04376 14.8875L11.0438 18.09C11.4708 18.4289 12.0182 18.4595 12.4697 18.1698C12.9212 17.8802 13.2039 17.3168 13.2063 16.7025V7.2975C13.2039 6.68318 12.9212 6.11983 12.4697 5.83016C12.0182 5.5405 11.4708 5.57115 11.0438 5.91Z" stroke="var(--borderWhite)" stroke-width="2"/>
                <g id="high-vol-path" clip-path="url(#clip1_2964_39)">
                  <path d="M16.5174 9.10336C18.1171 10.7031 18.1171 13.2968 16.5174 14.8966M18.6898 6.93091C21.4894 9.73047 21.4894 14.2695 18.6898 17.069" stroke="var(--borderWhite)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </g>
                <g id="muted-path">
                  <path d="M17 10L21 14M21 10L17 14" stroke="var(--borderWhite)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </g>
                <clipPath id="clip1_2964_39">
                  <rect width="12.2892" height="12.2892" fill="var(--borderWhite)" transform="translate(18.6898 3.31018) rotate(45)"/>
                </clipPath>
              </svg>
            </media-mute-button>
          ...
          <div class="player-button-group currentChapter">
            ...
            <media-tooltip placement="top">Chapter</media-tooltip>
              ...
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M9 6L14.2929 11.2929C14.6834 11.6834 14.6834 12.3166 14.2929 12.7071L9 18" stroke="var(--borderWhite)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </g>
                <defs>
              </svg>
            </media-current-chapter>
          ...
          <div class="player-button-group">
            ...
            <media-airplay-button class="media-button custom-btn">
              <svg viewBox="0 0 24 24" aria-hidden="true" slot="icon">
                <g clip-path="url(#clip0_2964_39)">
                <path d="M6 17H5C3.89543 17 3 16.1046 3 15V7C3 5.89543 3.89543 5 5 5H19C20.1046 5 21 5.89543 21 7V15C21 16.1046 20.1046 17 19 17H18M8 20L12 15L16 20H8Z" stroke="var(--borderWhite)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </g>
                <defs>
              </svg>
            ...
            <media-theater-mode-button id="media-theater-mode-button" class="media-button custom-btn" type="button" aria-label="theater mode">
              ...
              <button style="background-color: transparent; border: none; cursor: pointer; outline: none;">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M2 7C2 5.89543 2.89543 5 4 5H20C21.1046 5 22 5.89543 22 7V17C22 18.1046 21.1046 19 20 19H4C2.89543 19 2 18.1046 2 17V7Z" stroke="var(--borderWhite)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M9.33333 9.33325L6 11.9999L9.33333 14.6666M14.6667 14.6666L18 11.9999L14.6667 9.33325" stroke="var(--borderWhite)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </button>
            ...
            <media-fullscreen-button class="media-button custom-btn">
              <svg slot="enter" viewBox="0 0 24 24">
                ...
                <path d="M5 15.5V17C5 18.1046 5.89543 19 7 19H8.5M19 15.5V17C19 18.1046 18.1046 19 17 19H15.5M5 8.5V7C5 5.89543 5.89543 5 7 5H8.5M19 8.5V7C19 5.89543 18.1046 5 17 5H15.5" stroke="var(--borderWhite)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
              <svg slot="exit" viewBox="0 0 24 24">
                <use class="svg-shadow" xlink:href="#fs-exit-paths"></use>
                <path d="M8.50001 19.0001L8.50001 17.5001C8.50001 16.3956 7.60458 15.5001 6.50001 15.5001H5.00001M15.5 19.0001V17.5001C15.5 16.3956 16.3954 15.5001 17.5 15.5001L19 15.5001M8.5 5.00012L8.5 6.50012C8.5 7.60469 7.60457 8.50012 6.5 8.50012L5 8.50012M15.5 5.00015L15.5 6.50015C15.5 7.60472 16.3954 8.50015 17.5 8.50015L19 8.50015" stroke="var(--borderWhite)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
