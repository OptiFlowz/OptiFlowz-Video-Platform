...
router.get('/my/playlists', requireAuth, requirePermission(Permissions.PLAYLISTS_UPDATE_OWN), handleGetMyPlaylists);
router.patch("/playlist-details/:playlistId", requireAuth, requirePlaylistUpdate, handlePatchPlaylistDetails);
router.post("/:playlistId/thumbnail", requireAuth, requirePlaylistUpdate, playlistThumbnailUploadMiddleware, handlePlaylistThumbnailUpload);

// playlists.routes.js
router.post("/:playlistId/items", requireAuth, requirePlaylistUpdate, addVideoToPlaylist);
router.delete("/:playlistId/items/:videoId", requireAuth, requirePlaylistUpdate, removeVideoFromPlaylist);
...
router.post("/playlist/create", requireAuth, requirePermission(Permissions.PLAYLISTS_CREATE), handleCreatePlaylist);
